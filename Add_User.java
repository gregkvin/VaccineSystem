...
public class Add_User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Vaccination Status");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            int line = fh.readLineNumber("login.txt"); int n = 0;
            String[] username = fw.readUsername("login.txt");
            boolean duplicate = fw.checkDuplicate(usernameee.getText());
            if(duplicate == true){
                JOptionPane.showMessageDialog(null, "Username has already taken!");
            } else {
                
                String [] input = {id.getText(),name.getText(),usernameee.getText(),dob.getText(),
                    email.getText(),nationality.getText(),
                    (String)status.getSelectedItem()};
                if(input[0].equals("")||input[1].equals("")||input[2].equals("")
                        ||input[3].equals("")||input[4].equals("")||input[5].equals("")||input[6].equals("")){
                    JOptionPane.showMessageDialog(null, "Incomplete credentials, you have not fill one or more information.");
                } else {
                    try {
                        fw.appendUser("login.txt", input);
